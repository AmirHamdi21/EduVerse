...
1. **Given** a user is logged in and enrolled or assigned to a course, **When** they navigate into the course from their main dashboard, **Then** they should see a clear, chronologically or logically ordered list of course modules/weeks.
...
- **FR-005**: System MUST adapt the content viewing interface dynamically to cleanly present information to all supported user roles transparently.
