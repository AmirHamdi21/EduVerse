...
void main() {
  group('RosterCubit', () {
    ...
    test('loadCourses auto-selects a section and resolves instructor info', () async {
    ...
    test('filteredStudents searches identity fields and sorts by status when selected', () async {
      await cubit.loadCourses();
    ...
    test('surfaces errors when course loading fails', () async {
      fakeEnrollmentService.teachingResult =
    ...
    test('does not emit after close while async loads are still running', () async {
      ...
      fakeEnrollmentService.instructorsDelay = const Duration(milliseconds: 10);
