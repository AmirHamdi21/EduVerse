...
class TADiscussionPostDetailScreen extends StatefulWidget {
  const TADiscussionPostDetailScreen({
    super.key,
  ...
  @override
  State<TADiscussionPostDetailScreen> createState() =>
      _TADiscussionPostDetailScreenState();
}

class _TADiscussionPostDetailScreenState
    extends State<TADiscussionPostDetailScreen>
      ...
      children: <Widget>[
        if (thread.isLocked)
          Container(
            ...
            child: Row(
              children: <Widget>[
                const Icon(Icons.lock_rounded, color: TAColors.warning),
                const SizedBox(width: 10),
                Expanded(
                  child: Text(
  ...
  Widget _buildDetailsTab(
    ...
    final info = <({String label, String value})>[
      (
        ...
        value: taDiscussionDisplayName(context, thread.createdByName),
      ),
      (
        label: l10n.course,
        value: _course == null
      ...
      (
        ...
        value: taDiscussionFormatDate(context, thread.createdAt),
      ),
      (
        label: l10n.instructorDiscussionUpdatedLabel,
        value: taDiscussionFormatDate(context, thread.updatedAt),
      ),
      (
        label: l10n.status,
    ...
    return Container(
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          const SizedBox(height: 4),
          Text(
            taDiscussionFormatDate(context, reply.createdAt),
            style: TextStyle(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(
            color: reply.isAnswer
                ? TAColors.success.withValues(alpha: 0.35)
              ...
              children: <Widget>[
                TextButton.icon(
                  ...
                  style: TextButton.styleFrom(
                    foregroundColor: TAColors.accent,
            ...
            Container(
              ...
              child: Row(
                children: <Widget>[
                  Expanded(
                    child: Text(
                      '${l10n.replyingTo}: ${taDiscussionDisplayName(context, _replyingTo!.userName)}',
                      style: const TextStyle(
                        color: TAColors.primary,
                        fontSize: 12,
                        fontWeight: FontWeight.w700,
