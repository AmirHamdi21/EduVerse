...
class _TADiscussionsScreenState extends State<TADiscussionsScreen> {
  ...
  Widget _buildFilters(
    ...
    return TADiscussionFilterPanel(
      ...
      children: <Widget>[
        Expanded(
          child: TADiscussionDropdown<_CourseFilter>(
            isDark: isDark,
        ...
        Expanded(
          child: TADiscussionDropdown<_CourseSort>(
            isDark: isDark,
  ...
  Future<void> _openCourse(BuildContext context, _CourseSummary summary) async {
    await context.push(
      '/ta/course/${summary.course.courseId}/discussions',
