...
class _TAGradingCenterScreenState extends State<TAGradingCenterScreen> {
  ...
  Future<void> _loadSubmissions({bool refresh = false}) async {
    ...
    try {
      ...
      final relevantCourses = coursesStatus.data
          .where(
            (course) =>
  ...
  Widget _buildCourseSubmissionCard(
    ...
    return Container(
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(28),
        border: Border.all(
          color: TAColors.borderColor(isDark).withValues(alpha: 0.82),
        ),
        boxShadow: <BoxShadow>[
          BoxShadow(
            color: Colors.black.withValues(alpha: isDark ? 0.18 : 0.05),
            ...
            decoration: BoxDecoration(
              gradient: LinearGradient(
                colors: <Color>[
                  ...
                  TAColors.tealLight.withValues(alpha: 0.85),
                ],
        ...
        children: <Widget>[
          Row(
            ...
            children: <Widget>[
              Container(
                ...
                decoration: BoxDecoration(
                  shape: BoxShape.circle,
                  border: Border.all(color: TAColors.primary, width: 2),
                ),
                alignment: Alignment.center,
                child: Text(
          ...
          Container(
            ...
            decoration: BoxDecoration(
              gradient: LinearGradient(
                colors: <Color>[
                  TAColors.successLight.withValues(alpha: 0.92),
                  TAColors.tealLight.withValues(alpha: 0.84),
                ],
                begin: Alignment.topLeft,
                end: Alignment.bottomRight,
              ),
              borderRadius: BorderRadius.circular(18),
              border: Border.all(
                color: TAColors.success.withValues(alpha: 0.18),
              ),
            ),
            child: Row(
              children: <Widget>[
              ...
              Expanded(
                child: OutlinedButton.icon(
                  ...
                  style: OutlinedButton.styleFrom(
                    ...
                    side: BorderSide(
                      color: TAColors.primary.withValues(alpha: 0.30),
                    ),
  ...
  Widget _buildMetaItem({
    ...
    return Row(
      children: <Widget>[
        Icon(icon, size: 16, color: TAColors.textTertiaryColor(isDark)),
  ...
  _StatusBadge _statusBadge(_SubmissionEntry entry) {
    if (entry.isGraded) {
      return _StatusBadge(
        ...
        foreground: TAColors.success,
        background: TAColors.successLight,
      );
    }
    if (entry.submission.isLate) {
      return _StatusBadge(
        label: AppLocalizations.of(context).late,
        foreground: TAColors.error,
        background: TAColors.errorLight,
      );
    }
    return _StatusBadge(
      label: AppLocalizations.of(context).pending,
      foreground: TAColors.warning,
      background: TAColors.warningLight,
    );
  }
  ...
  Widget _buildInfoPill({required IconData icon, required String label}) {
    return Container(
      ...
      child: Row(
        mainAxisSize: MainAxisSize.min,
        children: <Widget>[
          Icon(icon, size: 15, color: TAColors.primary),
          const SizedBox(width: 6),
          Text(
            label,
            style: const TextStyle(
    ...
    return Column(
      ...
      children: <Widget>[
        ...
        DropdownButtonFormField<T>(
          ...
          isExpanded: true,
          decoration: InputDecoration(
            prefixIcon: Icon(icon, color: TAColors.primary, size: 20),
