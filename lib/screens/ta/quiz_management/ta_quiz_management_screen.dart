...
class _State extends State<TAQuizManagementScreen>
            ...
            child: ListView.separated(
              ...
              itemBuilder: (_, i) {
                ...
                return GestureDetector(
                  onTap: () =>
                      context.read<QuizManagementCubit>().setStatusFilter(f),
  ...
  Widget _errView(bool dk, String msg) => Center(
    child: Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          ElevatedButton.icon(
            onPressed: () => context.read<QuizManagementCubit>().loadQuizzes(),
...
class _Card extends StatelessWidget {
                ...
                Row(
                  children: [
                    ...
                    Container(
                      ...
                      child: Text(
                        quiz.quizType.name.toUpperCase(),
            ...
            child: Row(
              children: [
                _actBtn(
                  ...
                  Icons.people_outline_rounded,
                  'Attempts',
                  () => context.push('/ta/quiz-attempts', extra: quiz),
                ),
                const SizedBox(width: 8),
                _actBtn(
                  context,
                  Icons.bar_chart_rounded,
                  'Stats',
                  () => context.push('/ta/quiz-statistics', extra: quiz),
                ),
                const Spacer(),
                if (quiz.status == QuizStatusEnum.draft)
                  _pubBtn(context)
                else if (quiz.status == QuizStatusEnum.published)
                  _clsBtn(context),
              ],
            ),
          ),
  ...
  Widget _meta(IconData ic, String l) => Row(
    mainAxisSize: MainAxisSize.min,
    children: [
      Icon(ic, size: 14, color: TAColors.textTertiaryColor(isDark)),
  ...
  Widget _actBtn(BuildContext ctx, IconData ic, String l, VoidCallback tap) =>
      GestureDetector(
        onTap: tap,
        child: Container(
          ...
          child: Row(
            mainAxisSize: MainAxisSize.min,
            children: [
              Icon(ic, size: 15, color: TAColors.primary),
    ...
    child: Container(
      ...
      decoration: BoxDecoration(
        gradient: const LinearGradient(
          colors: [TAColors.success, Color(0xFF059669)],
        ),
        borderRadius: BorderRadius.circular(10),
      ),
      child: const Row(
        mainAxisSize: MainAxisSize.min,
        children: [
          Icon(Icons.publish_rounded, size: 15, color: Colors.white),
          SizedBox(width: 5),
          Text(
            'Publish',
            style: TextStyle(
  ...
  Widget _clsBtn(BuildContext ctx) => GestureDetector(
    ...
    child: Container(
      ...
      child: const Row(
        mainAxisSize: MainAxisSize.min,
        children: [
          Icon(Icons.lock_outline_rounded, size: 15, color: TAColors.error),
          SizedBox(width: 5),
          Text(
            'Close',
            style: TextStyle(
  ...
  PopupMenuItem<String> _mi(String v, IconData ic, String l, {Color? c}) =>
      PopupMenuItem(
        value: v,
        child: Row(
          children: [
            Icon(ic, size: 18, color: c ?? TAColors.textSecondaryColor(isDark)),
            const SizedBox(width: 10),
            Text(
              l,
              style: TextStyle(
                fontSize: 13,
                color: c ?? TAColors.textPrimaryColor(isDark),
                fontWeight: FontWeight.w500,
              ),
            ),
          ],
  ...
  void _onMenu(BuildContext ctx, String a) {
    switch (a) {
      case 'edit':
        ctx.push('/ta/quiz-edit', extra: quiz);
      case 'attempts':
        ctx.push('/ta/quiz-attempts', extra: quiz);
      case 'statistics':
        ctx.push('/ta/quiz-statistics', extra: quiz);
      case 'delete':
        showDialog(
          context: ctx,
          builder: (d) => AlertDialog(
            ...
            actions: [
              ...
              ElevatedButton(
                onPressed: () {
                  Navigator.pop(d);
                  ctx.read<QuizManagementCubit>().deleteQuiz(quiz.id);
                },
                style: ElevatedButton.styleFrom(
