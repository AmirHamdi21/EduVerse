      ...
      child: BlocBuilder<ThemeBloc, ThemeState>(
        builder: (context, themeState) {
          ...
          return TAWalkthroughRouteMarker(
            segmentId: TAWalkthroughIds.roster,
            child: SharedRosterScreen(
              isDark: isDark,
              fallbackRoute: '/ta/dashboard',
              walkthroughTargets: const SharedRosterWalkthroughTargets(
                header: TAWalkthroughIds.rosterHeader,
                controls: TAWalkthroughIds.rosterControls,
                list: TAWalkthroughIds.rosterList,
              ),
