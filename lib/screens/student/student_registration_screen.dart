    ...
    return BlocBuilder<ThemeBloc, ThemeState>(
      builder: (context, themeState) {
        ...
        return Scaffold(
          ...
          body:
              BlocConsumer<StudentRegistrationCubit, StudentRegistrationState>(
                        ...
                        if (state.enrolledCourses.isEmpty)
                          ...
                          SliverPadding(
                            ...
                            sliver: SliverList.builder(
                              ...
                              itemBuilder: (context, index) {
                                final enrollment = state.enrolledCourses[index];
          ...
          builder: (_, state) {
            return SectionSelectionSheet(
              ...
              onConfirm: () async {
                ...
                if (success && mounted && Navigator.of(sheetContext).canPop()) {
