...
class NoteSwipeSettingsScreen extends StatefulWidget {
  const NoteSwipeSettingsScreen({super.key});

  @override
  State<NoteSwipeSettingsScreen> createState() =>
      _NoteSwipeSettingsScreenState();
}

class _NoteSwipeSettingsScreenState extends State<NoteSwipeSettingsScreen> {
  String _leftSwipeAction = 'delete';
  String _rightSwipeAction = 'edit';
  ...
  Widget _buildActionSelector(
    ...
    final actions = [
      ...
      ('edit', l10n.edit, Icons.edit_rounded, const Color(0xFF3B82F6)),
      ('share', l10n.share, Icons.share_rounded, const Color(0xFF10B981)),
