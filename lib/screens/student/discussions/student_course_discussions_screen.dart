...
class StudentCourseDiscussionsScreen extends StatefulWidget {
  const StudentCourseDiscussionsScreen({
    super.key,
  ...
  @override
  State<StudentCourseDiscussionsScreen> createState() =>
      _StudentCourseDiscussionsScreenState();
}
...
class _StudentCourseDiscussionsScreenState
    extends State<StudentCourseDiscussionsScreen> {
  ...
  Future<void> _createPost() async {
    ...
    final draft = await showStudentDiscussionThreadComposer(context);
    if (draft == null) {
      return;
    }
                  ...
                  if (_loading) ...<Widget>[
                    ...
                    SliverToBoxAdapter(
                      child: StudentDiscussionSummaryHeader(
                        ...
                        responsive: r,
                        title: _course == null
                            ? l10n.studentCourseDiscussionHeaderTitle
                    ...
                    if (threads.isEmpty)
                      SliverFillRemaining(
                        child: StudentDiscussionEmptyState(
                          ...
                          title: l10n.studentDiscussionNoPostsTitle,
                          message: l10n.studentDiscussionNoPostsSubtitle,
                          action: FilledButton.icon(
                            onPressed: _submitting ? null : _createPost,
                            style: FilledButton.styleFrom(
                              backgroundColor: StudentDiscussionPalette.primary,
  ...
  Widget _buildFilters(
    ...
    return StudentDiscussionFilterPanel(
      ...
      children: <Widget>[
        Expanded(
          child: StudentDiscussionDropdown<_PostFilter>(
            isDark: isDark,
            label: l10n.status,
        ...
        Expanded(
          child: StudentDiscussionDropdown<_PostSort>(
            isDark: isDark,
