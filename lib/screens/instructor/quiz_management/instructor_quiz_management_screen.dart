...
class _State extends State<InstructorQuizManagementScreen>
  ...
  Widget _createBtn() => GestureDetector(
    onTap: () {
      ...
      context.push('/instructor/quiz-create');
    },
    child: Container(
  ...
  Widget _listView(bool dk, QuizMgmtLoaded st, ResponsiveUtil r) {
    ...
    return RefreshIndicator(
      ...
      child: ListView.builder(
        ...
        itemCount: q.length,
        itemBuilder: (_, i) => _QuizCard(quiz: q[i], isDark: dk),
      ),
    );
  }
}
...
class _QuizCard extends StatelessWidget {
            ...
            child: Row(
              children: [
                _actBtn(
                  ...
                  Icons.people_outline_rounded,
                  'Attempts',
                  () => context.push('/instructor/quiz-attempts', extra: quiz),
                ),
                const SizedBox(width: 8),
                _actBtn(
                  context,
                  ...
                  'Stats',
                  () =>
                      context.push('/instructor/quiz-statistics', extra: quiz),
                ),
                const Spacer(),
  ...
  Widget _meta(IconData ic, String l) => Row(
    mainAxisSize: MainAxisSize.min,
    children: [
      Icon(ic, size: 14, color: InstructorColors.textTertiaryColor(isDark)),
      ...
      GestureDetector(
        ...
        child: Container(
          ...
          child: Row(
            mainAxisSize: MainAxisSize.min,
            children: [
              Icon(ic, size: 15, color: InstructorColors.primary),
    ...
    child: Container(
      ...
      decoration: BoxDecoration(
        gradient: const LinearGradient(
          colors: [InstructorColors.success, Color(0xFF059669)],
        ),
        borderRadius: BorderRadius.circular(10),
      ),
      child: const Row(
  ...
  Widget _clsBtn(BuildContext ctx) => GestureDetector(
    ...
    child: Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(10),
        border: Border.all(
          color: InstructorColors.error.withValues(alpha: 0.3),
        ),
      ),
      child: const Row(
        mainAxisSize: MainAxisSize.min,
        ...
        child: Row(
          children: [
            Icon(
              ic,
              size: 18,
              color: c ?? InstructorColors.textSecondaryColor(isDark),
            ),
            ...
            Text(
              ...
              style: TextStyle(
                fontSize: 13,
                color: c ?? InstructorColors.textPrimaryColor(isDark),
                fontWeight: FontWeight.w500,
              ),
            ),
          ],
  ...
  void _onMenu(BuildContext ctx, String a) {
    switch (a) {
      case 'edit':
        ctx.push('/instructor/quiz-edit', extra: quiz);
      case 'attempts':
        ctx.push('/instructor/quiz-attempts', extra: quiz);
      case 'statistics':
        ctx.push('/instructor/quiz-statistics', extra: quiz);
      case 'delete':
        _confirmDel(ctx);
    }
  }
