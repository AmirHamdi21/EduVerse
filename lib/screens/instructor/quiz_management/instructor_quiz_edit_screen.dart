...
class _EditState extends State<InstructorQuizEditScreen> with SingleTickerProviderStateMixin {
      ...
      Material(color: Colors.transparent, child: InkWell(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(borderRadius: BorderRadius.circular(14),
            border: Border.all(color: InstructorColors.primary.withValues(alpha: 0.4), style: BorderStyle.solid, width: 1.5)),
          child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
            Icon(Icons.add_rounded, color: InstructorColors.primary, size: 20),
            const SizedBox(width: 8),
            Text('Add Question', style: TextStyle(color: InstructorColors.primary, fontWeight: FontWeight.w600, fontSize: 14)),
          ]),
        ),
      )),
      const SizedBox(height: 80),
  ...
  Widget _buildQuestionCard(bool dk, int idx, _QuestionDraft q) {
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        // Header row
        Row(children: [
          Container(width: 28, height: 28, decoration: BoxDecoration(color: InstructorColors.primary.withValues(alpha: 0.1), borderRadius: BorderRadius.circular(8)),
            child: Center(child: Text('${idx + 1}', style: TextStyle(color: InstructorColors.primary, fontWeight: FontWeight.w700, fontSize: 12)))),
          ...
          ...q.options.asMap().entries.map((e) => Padding(
            ...
            child: Row(children: [
              Radio<int>(value: e.key, groupValue: int.tryParse(q.correctAnswer?.toString() ?? '0') ?? 0,
                onChanged: (v) => setState(() => q.correctAnswer = v.toString()), activeColor: InstructorColors.primary),
  ...
  InputDecoration _inputDeco(bool dk, String label) => InputDecoration(
    ...
    focusedBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(12), borderSide: BorderSide(color: InstructorColors.primary, width: 1.5)),
