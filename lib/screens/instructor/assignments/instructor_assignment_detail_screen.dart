...
class InstructorAssignmentDetailScreen extends StatefulWidget {
  const InstructorAssignmentDetailScreen({
    super.key,
  ...
  @override
  State<InstructorAssignmentDetailScreen> createState() =>
      _InstructorAssignmentDetailScreenState();
}

class _InstructorAssignmentDetailScreenState
    extends State<InstructorAssignmentDetailScreen>
      ...
      builder: (context, themeState) {
        ...
        if (_loadingAssignment && _assignment == null) {
          return Scaffold(
            ...
            appBar: AppBar(
              backgroundColor: InstructorColors.background(isDark),
              title: Text(l10n.assignmentDetails),
            ),
            body: Center(
        ...
        child: Column(
          ...
          children: <Widget>[
            Container(
              ...
              child: Icon(icon, size: 40, color: InstructorColors.primary),
            ),
            const SizedBox(height: 16),
            Text(
              message,
  ...
  Future<void> _openGradingScreen(
    ...
    final result = await context.push<bool>(
      '/instructor/assignments/${assignment.assignmentId}/submissions/${submission.id}/grading',
      extra: <String, dynamic>{
