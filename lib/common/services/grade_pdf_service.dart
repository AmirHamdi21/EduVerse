...
class GradePdfReportService {
  ...
  Future<void> generateAndShareReport({
    ...
    try {
      ...
      final fileName = 'EduVerse_Grade_Report_${DateFormat('yyyy-MM-dd_HHmm').format(DateTime.now())}.pdf';
  ...
  Future<Uint8List> _generatePdf(
    ...
    pdf.addPage(
      pw.MultiPage(
        ...
        footer: (context) => _buildPageFooter(context.pageNumber, context.pagesCount),
        build: (context) => [
            ...
            children: [
                    ...
                    pw.Row(
                      children: [
                        pw.Container(
                          ...
                          child: pw.Center(
                            child: pw.Text(
                              data.studentName.isNotEmpty ? data.studentName[0].toUpperCase() : 'S',
                              style: pw.TextStyle(
                                font: _boldFont,
                                fontSize: 28,
                                color: PdfColors.white,
                    ...
                    pw.Row(
                      ...
                      children: [
                        ...
                        _buildCoverStat(
                          ...
                          data.currentSemester.contains(' ') ? data.currentSemester.split(' ')[1] : '',
                          _infoColor,
                        ),
                      ],
                    ),
              ...
              pw.Container(
                ...
                child: pw.Row(
                  ...
                  children: [
                    pw.Text(
                      _isArabic ? 'تم إنشاؤه بواسطة EduVerse' : 'Generated by EduVerse Academic System',
                      style: pw.TextStyle(
                        font: _regularFont,
                        fontSize: 10,
                        color: PdfColors.white,
  ...
  pw.Widget _buildCoverStat(String label, String value, String suffix, PdfColor color) {
    return pw.Column(
      children: [
        pw.RichText(
          text: pw.TextSpan(
  ...
  pw.Widget _buildAcademicSummary(GradeReportData data) {
    return pw.Container(
      ...
      child: pw.Column(
        ...
        children: [
          pw.Text(
            _isArabic ? 'ملخص الأداء الأكاديمي' : 'Academic Performance Summary',
            style: pw.TextStyle(
              font: _boldFont,
              fontSize: 18,
              color: PdfColors.white,
  ...
  pw.Widget _buildSummaryCard(String label, String value, String subtitle, String badge) {
    return pw.Expanded(
      child: pw.Container(
              ...
              children: [
                ...
                pw.Container(
                  ...
                  child: pw.Column(
                    ...
                    crossAxisAlignment: pw.CrossAxisAlignment.end,
                    children: [
                      pw.Text('4.0', style: pw.TextStyle(font: _regularFont, fontSize: 8, color: _textMuted)),
                      pw.Text('3.0', style: pw.TextStyle(font: _regularFont, fontSize: 8, color: _textMuted)),
                      pw.Text('2.0', style: pw.TextStyle(font: _regularFont, fontSize: 8, color: _textMuted)),
                      pw.Text('1.0', style: pw.TextStyle(font: _regularFont, fontSize: 8, color: _textMuted)),
                      pw.Text('0.0', style: pw.TextStyle(font: _regularFont, fontSize: 8, color: _textMuted)),
                    ],
                  ),
                ),
                pw.SizedBox(width: 10),
                ...
                pw.Expanded(
                  child: pw.Row(
                    ...
                    children: data.gpaTrend.map((point) {
                      ...
                      final color = point.gpa >= 3.5 ? _successColor 
                          : point.gpa >= 2.5 ? _warningColor 
                          : _dangerColor;
                      return pw.Column(
  ...
  pw.Widget _buildGradeDistributionSection(GradeReportData data) {
    ...
    final gradeColors = {
      'A+': _successColor, 'A': _successColor, 'A-': const PdfColor.fromInt(0xFF22C55E),
      'B+': const PdfColor.fromInt(0xFF84CC16), 'B': _warningColor, 'B-': _warningColor,
      'C+': const PdfColor.fromInt(0xFFF97316), 'C': const PdfColor.fromInt(0xFFF97316), 'C-': const PdfColor.fromInt(0xFFEA580C),
      'D+': _dangerColor, 'D': _dangerColor, 'F': const PdfColor.fromInt(0xFFDC2626),
    };
  ...
  List<pw.Widget> _buildSemesterCourseSections(GradeReportData data) {
    ...
    widgets.add(
      pw.Text(
        _isArabic ? 'تفاصيل المقررات حسب الفصل الدراسي' : 'Detailed Course Grades by Semester',
        style: pw.TextStyle(
          font: _boldFont,
          fontSize: 20,
          color: _textPrimary,
    ...
    coursesBySemester.forEach((semesterName, courses) {
      ...
      final totalCredits = courses.fold<int>(0, (sum, c) => sum + c.creditHours);
      
      widgets.add(
        pw.Container(
          margin: pw.EdgeInsets.only(bottom: 20, top: semesterIndex > 0 ? 10 : 0),
          decoration: pw.BoxDecoration(
            color: PdfColors.white,
            borderRadius: pw.BorderRadius.circular(12),
            border: pw.Border.all(color: _borderColor),
          ...
          child: pw.Column(
            children: [
                  ...
                  children: [
                    pw.Expanded(
                      ...
                      child: pw.Text(
                        ...
                        style: pw.TextStyle(font: _semiBoldFont, fontSize: 9, color: _textSecondary),
                      ),
                    ),
                    pw.Expanded(
                      child: pw.Text(
              ...
              ...courses.asMap().entries.map((entry) {
                ...
                final gradeColor = PdfColor.fromInt(course.currentGrade.color.toARGB32());
                      ...
                      pw.Expanded(
                        ...
                        child: pw.Column(
                          ...
                          children: [
                            pw.Text(
                              course.courseName,
                              style: pw.TextStyle(font: _semiBoldFont, fontSize: 10, color: _textPrimary),
                            ),
                            pw.SizedBox(height: 2),
                            pw.Row(
                              children: [
                                pw.Text(
                                  course.courseCode,
                                  style: pw.TextStyle(font: _regularFont, fontSize: 8, color: _textMuted),
                                ),
                                pw.Text(' • ', style: pw.TextStyle(color: _textMuted, fontSize: 8)),
                                pw.Text(
                                  course.instructor,
                                  style: pw.TextStyle(font: _regularFont, fontSize: 8, color: _textMuted),
                                ),
                        ...
                        child: pw.Column(
                          children: [
                              ...
                              child: pw.Row(
                                children: [
                                  ...
                                  if (course.currentPercentage < 100)
                                    pw.Expanded(
                                      flex: (100 - course.currentPercentage).round(),
                                      child: pw.Container(),
                                    ),
                                ],
                              ),
                            ...
                            pw.Text(
                              ...
                              style: pw.TextStyle(font: _regularFont, fontSize: 7, color: _textMuted),
                            ),
                          ],
                        ),
                      ),
                      ...
                      pw.Expanded(
                        child: pw.Container(
                          ...
                          child: pw.Text(
                            ...
                            style: pw.TextStyle(font: _boldFont, fontSize: 10, color: PdfColors.white),
                            textAlign: pw.TextAlign.center,
                          ),
                        ),
                      ),
  ...
  pw.Widget _buildPerformanceInsights(GradeReportData data) {
    ...
    final passRate = stats?.passRate ?? 
        (data.courses.where((c) => c.currentGrade.gpa >= 1.0).length / data.courses.length * 100);
        ...
        children: [
          pw.Row(
            children: [
              ...
              pw.SizedBox(width: 10),
              pw.Text(
                _isArabic ? 'رؤى الأداء والتوصيات' : 'Performance Insights & Recommendations',
                style: pw.TextStyle(
                  font: _boldFont,
                  fontSize: 16,
                  color: _textPrimary,
                      ...
                      pw.Row(
                        children: [
                          pw.Container(
                            ...
                            child: pw.Center(
                              child: pw.Text('★', style: pw.TextStyle(color: PdfColors.white, fontSize: 14)),
                            ),
                          ),
                          pw.SizedBox(width: 8),
                          pw.Text(
                            _isArabic ? 'نقاط القوة' : 'Strengths',
                            style: pw.TextStyle(font: _boldFont, fontSize: 12, color: _successColor),
                          ),
                        ],
                      ),
                      pw.SizedBox(height: 12),
                      ...topCourses.take(3).map((course) => pw.Padding(
                          ...
                          children: [
                            ...
                            pw.Expanded(
                              child: pw.Text(
                                ...
                                style: pw.TextStyle(font: _regularFont, fontSize: 9, color: _textPrimary),
                              ),
                            ),
                          ],
                        ),
                ...
                child: pw.Container(
                  ...
                  child: pw.Column(
                    ...
                    children: [
                      pw.Row(
                        children: [
                          pw.Container(
                            ...
                            child: pw.Center(
                              child: pw.Text('!', style: pw.TextStyle(color: PdfColors.white, fontSize: 14, font: _boldFont)),
                            ),
                          ),
                          pw.SizedBox(width: 8),
                          pw.Text(
                            _isArabic ? 'يحتاج اهتمام' : 'Needs Focus',
                            style: pw.TextStyle(font: _boldFont, fontSize: 12, color: _warningColor),
                          ),
                        ],
                      ),
                      pw.SizedBox(height: 12),
                      ...bottomCourses.take(3).where((c) => c.currentPercentage < 80).map((course) => pw.Padding(
                        padding: const pw.EdgeInsets.only(bottom: 6),
                        child: pw.Row(
                          children: [
                            pw.Container(
                      ...
                      if (bottomCourses.where((c) => c.currentPercentage < 80).isEmpty)
                        pw.Text(
                          _isArabic ? 'أداء ممتاز في جميع المقررات!' : 'Excellent performance across all courses!',
                          style: pw.TextStyle(font: _regularFont, fontSize: 9, color: _textSecondary),
                        ),
                    ],
                  ),
                ),
          ...
          pw.Container(
            ...
            child: pw.Row(
              mainAxisAlignment: pw.MainAxisAlignment.spaceAround,
              children: [
                _buildMetricItem(_isArabic ? 'نسبة النجاح' : 'Pass Rate', '${passRate.toStringAsFixed(0)}%', _successColor),
                _buildMetricItem(_isArabic ? 'متوسط النسبة' : 'Avg Score', 
                    '${(data.courses.fold<double>(0, (sum, c) => sum + c.currentPercentage) / data.courses.length).toStringAsFixed(1)}%', _primaryColor),
                _buildMetricItem(_isArabic ? 'أعلى تقدير' : 'Best Grade', topCourses.first.currentGrade.label, _successColor),
                _buildMetricItem(_isArabic ? 'الفصول المكتملة' : 'Semesters', '${data.semesters.length}', _infoColor),
              ],
            ),
          ),
        ],
  ...
  pw.Widget _buildMetricItem(String label, String value, PdfColor color) {
    return pw.Column(
      children: [
        ...
        pw.Text(
          label,
          style: pw.TextStyle(font: _regularFont, fontSize: 8, color: _textSecondary),
        ),
      ],
    );
  }
    ...
    return pw.Container(
      ...
      child: pw.Column(
        ...
        children: [
          pw.Text(
            label,
            style: pw.TextStyle(font: _regularFont, fontSize: 10, color: PdfColors.white.shade(0.8)),
          ),
          pw.SizedBox(height: 8),
          pw.Text(
            value,
          ...
          pw.Text(
            ...
            style: pw.TextStyle(font: _semiBoldFont, fontSize: 9, color: PdfColors.white),
          ),
        ],
      ),
    );
          ...
          pw.Column(
            ...
            children: [
              pw.Text(
                ...
                style: pw.TextStyle(font: _semiBoldFont, fontSize: 10, color: _textSecondary),
              ),
              pw.SizedBox(height: 4),
              pw.Text(
                '${_isArabic ? 'تاريخ الإنشاء:' : 'Generated:'} ${DateFormat('dd MMM yyyy, HH:mm').format(DateTime.now())}',
                style: pw.TextStyle(font: _regularFont, fontSize: 9, color: _textMuted),
              ),
              pw.Text(
                '${_isArabic ? 'رقم الطالب:' : 'Student ID:'} ${data.studentId}',
                style: pw.TextStyle(font: _regularFont, fontSize: 9, color: _textMuted),
            ...
            child: pw.Column(
              children: [
                ...
                pw.Text(
                  ...
                  style: pw.TextStyle(font: _regularFont, fontSize: 8, color: PdfColors.white.shade(0.8)),
                ),
              ],
            ),
          ),
