...
class QuestionBankSkeletons extends StatefulWidget {
  const QuestionBankSkeletons({super.key, this.itemCount = 4});

  final int itemCount;

  @override
  State<QuestionBankSkeletons> createState() => _QuestionBankSkeletonsState();
}

class _QuestionBankSkeletonsState extends State<QuestionBankSkeletons>
                            ...
                            child: Column(
                              ...
                              children: [
                                FractionallySizedBox(
                                  ...
                                  child: _SkeletonLine(
                                    color: Colors.white.withValues(alpha: 0.16),
                                    highlight: Colors.white.withValues(
                                      alpha: 0.34,
                                    ),
                                    progress: progress,
                                    height: 18,
                        ...
                        Positioned(
                          ...
                          child: IgnorePointer(
                            child: _SkeletonLine(
                              ...
                              highlight: InstructorColors.primaryLight
  ...
  int _visibleItemCount(BoxConstraints constraints) {
    ...
    const heroAndFiltersHeight = 318.0;
    const rowHeight = 126.0;
    final available = constraints.maxHeight - heroAndFiltersHeight;
