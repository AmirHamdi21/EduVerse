...
class _InstructorDrawerState extends State<InstructorDrawer>
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    gradient: const LinearGradient(
                      ...
                      colors: [Color(0xFF155CFB), Color(0xFF3B82F6)],
                    ),
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          _buildStatItem(isDark, '163', l10n.students, Icons.people_rounded),
          _buildStatDivider(isDark),
          _buildStatItem(isDark, '12', l10n.pending, Icons.grading_rounded),
        ],
      ),
    );
  }
  ...
  Widget _buildStatItem(
    ...
    return Column(
      ...
      children: [
        Icon(icon, color: const Color(0xFF155CFB), size: 20),
              ...
              gradient: isSelected
                  ? LinearGradient(
                      colors: item.isHighlighted
                          ? [const Color(0xFF3B82F6), const Color(0xFF155CFB)]
                          : [
