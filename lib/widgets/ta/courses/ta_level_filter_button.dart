...
class TALevelFilterButton extends StatelessWidget {
  final String selectedCategory;
  final List<String> categories;
  final String Function(String category) labelBuilder;
  final ValueChanged<String> onCategoryChanged;

  const TALevelFilterButton({
    super.key,
                        ...
                        child: Text(
                          ...
                          style: TextStyle(
                            color: selectedCategory == category
                                ...
                                : TACoursesTheme.primaryText(isDark),
                            fontSize: 14,
              ...
              return Container(
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border.all(
                    color: isActive
                        ? TACoursesTheme.accentBlue
                        : TACoursesTheme.borderColor(isDark),
                ...
                child: Row(
                  children: [
                    Container(
                      ...
                      height: 38,
                      decoration: BoxDecoration(
                        color: TACoursesTheme.accentBlue.withValues(
