...
class AdminNotificationSwipeSettingsService {
  static const String _swipeSettingsKey = 'admin_notification_swipe_settings';
  static AdminNotificationSwipeSettingsService? _instance;
  NotificationSwipeSettings? _cachedSettings;

  AdminNotificationSwipeSettingsService._();

  static AdminNotificationSwipeSettingsService get instance {
    _instance ??= AdminNotificationSwipeSettingsService._();
    return _instance!;
  }
