# Roster — Teaching Assistant (TA) Feature Documentation

## 1. Feature Summary
The **Roster** capability belongs to the **Teaching Assistant (TA)** role and is grouped under **Communication & Discussions**. This document captures implementation intent, navigation, architecture touchpoints, and operational expectations for maintainable evolution.

## 2. Access and Navigation
| Item | Details |
|---|---|
| Role Access | Teaching Assistant (TA) |
| Primary Route | `/ta/roster` |
| Primary Screen | `lib/screens/ta/roster/ta_roster_screen.dart` |
...
- `lib/config/app_router.dart`
- `lib/screens/ta/roster/ta_roster_screen.dart`
