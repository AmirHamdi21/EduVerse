# Grading Center — Teaching Assistant (TA) Feature Documentation

## 1. Feature Summary
The **Grading Center** capability belongs to the **Teaching Assistant (TA)** role and is grouped under **Assignments & Grading**. This document captures implementation intent, navigation, architecture touchpoints, and operational expectations for maintainable evolution.

## 2. Access and Navigation
| Item | Details |
|---|---|
| Role Access | Teaching Assistant (TA) |
| Primary Route | `/ta/grading` |
| Primary Screen | `lib/screens/ta/grading/ta_grading_center_screen.dart` |
