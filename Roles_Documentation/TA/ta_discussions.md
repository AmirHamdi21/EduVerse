# Discussions — Teaching Assistant (TA) Feature Documentation

## 1. Feature Summary
The **Discussions** capability belongs to the **Teaching Assistant (TA)** role and is grouped under **Communication & Discussions**. This document captures implementation intent, navigation, architecture touchpoints, and operational expectations for maintainable evolution.

## 2. Access and Navigation
| Item | Details |
|---|---|
| Role Access | Teaching Assistant (TA) |
| Primary Route | `/ta/discussions` |
| Primary Screen | `lib/screens/ta/discussions/ta_discussions_screen.dart` |
...
- `lib/config/app_router.dart`
- `lib/screens/ta/discussions/ta_discussions_screen.dart`
