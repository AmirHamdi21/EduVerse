# Assigned Courses — Teaching Assistant (TA) Feature Documentation

## 1. Feature Summary
The **Assigned Courses** capability belongs to the **Teaching Assistant (TA)** role and is grouped under **Courses & Materials**. This document captures implementation intent, navigation, architecture touchpoints, and operational expectations for maintainable evolution.

## 2. Access and Navigation
| Item | Details |
|---|---|
| Role Access | Teaching Assistant (TA) |
| Primary Route | `/ta/courses` |
| Primary Screen | `lib/screens/ta/courses/ta_courses_list_screen.dart` |
...
- `lib/config/app_router.dart`
- `lib/screens/ta/courses/ta_courses_list_screen.dart`
