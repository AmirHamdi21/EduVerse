# Attendance — Teaching Assistant (TA) Feature Documentation

## 1. Feature Summary
The **Attendance** capability belongs to the **Teaching Assistant (TA)** role and is grouped under **Labs & Attendance**. This document captures implementation intent, navigation, architecture touchpoints, and operational expectations for maintainable evolution.

## 2. Access and Navigation
| Item | Details |
|---|---|
| Role Access | Teaching Assistant (TA) |
| Primary Route | `/ta/attendance` |
| Primary Screen | `lib/screens/ta/attendance/ta_attendance_screen.dart` |
...
- **Current Notes:** Current role screen exists with active UX; full attendance API parity is still being finalized.
...
- `lib/config/app_router.dart`
- `lib/screens/ta/attendance/ta_attendance_screen.dart`
