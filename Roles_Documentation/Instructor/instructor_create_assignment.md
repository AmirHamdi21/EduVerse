# Create Assignment — Instructor Feature Documentation

## 1. Feature Summary
The **Create Assignment** capability belongs to the **Instructor** role and is grouped under **Assignments & Grading**. This document captures implementation intent, navigation, architecture touchpoints, and operational expectations for maintainable evolution.

## 2. Access and Navigation
| Item | Details |
|---|---|
| Role Access | Instructor |
| Primary Route | `/instructor/create-assignment` |
| Primary Screen | `lib/screens/instructor/create_assignment_screen.dart` |
...
## 5. Primary User Flow
1. User opens `/instructor/create-assignment`.
