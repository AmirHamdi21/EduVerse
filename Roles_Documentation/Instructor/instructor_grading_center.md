# Grading Center — Instructor Feature Documentation

## 1. Feature Summary
The **Grading Center** capability belongs to the **Instructor** role and is grouped under **Assignments & Grading**. This document captures implementation intent, navigation, architecture touchpoints, and operational expectations for maintainable evolution.

## 2. Access and Navigation
| Item | Details |
|---|---|
| Role Access | Instructor |
| Primary Route | `/instructor/grading` |
| Primary Screen | `lib/screens/instructor/grading_center/grading_center_screen.dart` |
...
## 5. Primary User Flow
1. User opens `/instructor/grading`.
...
- `lib/config/app_router.dart`
- `lib/screens/instructor/grading_center/grading_center_screen.dart`
