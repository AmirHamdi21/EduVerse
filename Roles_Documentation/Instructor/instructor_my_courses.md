# My Courses — Instructor Feature Documentation

## 1. Feature Summary
The **My Courses** capability belongs to the **Instructor** role and is grouped under **Courses & Content**. This document captures implementation intent, navigation, architecture touchpoints, and operational expectations for maintainable evolution.

## 2. Access and Navigation
| Item | Details |
|---|---|
| Role Access | Instructor |
| Primary Route | `/instructor/courses` |
...
## 5. Primary User Flow
1. User opens `/instructor/courses`.
