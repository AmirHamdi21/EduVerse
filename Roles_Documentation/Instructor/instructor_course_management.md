# Course Management — Instructor Feature Documentation

## 1. Feature Summary
The **Course Management** capability belongs to the **Instructor** role and is grouped under **Courses & Content**. This document captures implementation intent, navigation, architecture touchpoints, and operational expectations for maintainable evolution.

## 2. Access and Navigation
| Item | Details |
|---|---|
| Role Access | Instructor |
| Primary Route | `/instructor/course-management` |
| Primary Screen | `lib/screens/instructor/course_management/course_management_screen.dart` |
| Feature Category | Courses & Content |
...
## 5. Primary User Flow
1. User opens `/instructor/course-management`.
...
|---|---|
| State Management | instructor_courses_bloc, materials_bloc, course_structure_bloc |
| Service/API Layer | course_service.dart, material_service.dart, section_service.dart |
| Key Data Shapes | course metadata, material assets, section allocations |
...
- Validate course ownership before edits.
- Preserve content ordering consistency across views.
- Support draft/publish flow where applicable.
...
- `lib/config/app_router.dart`
- `lib/screens/instructor/course_management/course_management_screen.dart`
