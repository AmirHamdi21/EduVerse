# Assignment Submissions — Instructor Feature Documentation

## 1. Feature Summary
The **Assignment Submissions** capability belongs to the **Instructor** role and is grouped under **Assignments & Grading**. This document captures implementation intent, navigation, architecture touchpoints, and operational expectations for maintainable evolution.
...
| Primary Screen | `lib/screens/instructor/assignments/assignment_submissions_screen.dart` |
