# Roster — Instructor Feature Documentation

## 1. Feature Summary
The **Roster** capability belongs to the **Instructor** role and is grouped under **Analytics & Planning**. This document captures implementation intent, navigation, architecture touchpoints, and operational expectations for maintainable evolution.

## 2. Access and Navigation
| Item | Details |
|---|---|
| Role Access | Instructor |
| Primary Route | `/instructor/roster` |
| Primary Screen | `lib/screens/instructor/roster/instructor_roster_screen.dart` |
...
## 5. Primary User Flow
1. User opens `/instructor/roster`.
...
- `lib/config/app_router.dart`
- `lib/screens/instructor/roster/instructor_roster_screen.dart`
