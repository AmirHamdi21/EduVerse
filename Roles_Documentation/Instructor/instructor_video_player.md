# Video Player — Instructor Feature Documentation

## 1. Feature Summary
The **Video Player** capability belongs to the **Instructor** role and is grouped under **Courses & Content**. This document captures implementation intent, navigation, architecture touchpoints, and operational expectations for maintainable evolution.

## 2. Access and Navigation
| Item | Details |
|---|---|
| Role Access | Instructor |
| Primary Route | `/instructor/courses/:courseId/video/:videoId` |
| Primary Screen | `lib/screens/instructor/video/instructor_video_player_screen.dart` |
...
## 5. Primary User Flow
1. User opens `/instructor/courses/:courseId/video/:videoId`.
...
- `lib/config/app_router.dart`
- `lib/screens/instructor/video/instructor_video_player_screen.dart`
