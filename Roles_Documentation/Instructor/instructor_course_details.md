# Course Details — Instructor Feature Documentation

## 1. Feature Summary
The **Course Details** capability belongs to the **Instructor** role and is grouped under **Courses & Content**. This document captures implementation intent, navigation, architecture touchpoints, and operational expectations for maintainable evolution.

## 2. Access and Navigation
| Item | Details |
|---|---|
| Role Access | Instructor |
| Primary Route | `/instructor/courses/:courseId` |
| Primary Screen | `lib/screens/instructor/courses/instructor_courses_screen.dart` |
...
## 5. Primary User Flow
1. User opens `/instructor/courses/:courseId`.
...
- `lib/config/app_router.dart`
- `lib/screens/instructor/courses/instructor_courses_screen.dart`
