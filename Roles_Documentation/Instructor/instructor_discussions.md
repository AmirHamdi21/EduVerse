# Discussions — Instructor Feature Documentation

## 1. Feature Summary
The **Discussions** capability belongs to the **Instructor** role and is grouped under **Communication & Discussions**. This document captures implementation intent, navigation, architecture touchpoints, and operational expectations for maintainable evolution.

## 2. Access and Navigation
| Item | Details |
|---|---|
| Role Access | Instructor |
| Primary Route | `/instructor/discussions` |
| Primary Screen | `lib/screens/instructor/discussions/instructor_discussions_screen.dart` |
...
## 5. Primary User Flow
1. User opens `/instructor/discussions`.
...
- `lib/config/app_router.dart`
- `lib/screens/instructor/discussions/instructor_discussions_screen.dart`
