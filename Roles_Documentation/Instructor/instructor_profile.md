# Profile — Instructor Feature Documentation

## 1. Feature Summary
The **Profile** capability belongs to the **Instructor** role and is grouped under **Account & Settings**. This document captures implementation intent, navigation, architecture touchpoints, and operational expectations for maintainable evolution.

## 2. Access and Navigation
| Item | Details |
|---|---|
| Role Access | Instructor |
| Primary Route | `/instructor/profile` |
| Primary Screen | `lib/screens/instructor/profile/instructor_profile_screen.dart` |
...
## 5. Primary User Flow
1. User opens `/instructor/profile`.
