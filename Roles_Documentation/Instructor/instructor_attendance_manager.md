# Attendance Manager — Instructor Feature Documentation

## 1. Feature Summary
The **Attendance Manager** capability belongs to the **Instructor** role and is grouped under **Labs & Attendance**. This document captures implementation intent, navigation, architecture touchpoints, and operational expectations for maintainable evolution.

## 2. Access and Navigation
| Item | Details |
|---|---|
| Role Access | Instructor |
| Primary Route | `/instructor/attendance` |
| Primary Screen | `lib/screens/instructor/attendance/attendance_manager_screen.dart` |
...
## 5. Primary User Flow
1. User opens `/instructor/attendance`.
...
- **Current Notes:** UI workflows are in place; attendance backend parity is still being hardened.
...
- `lib/config/app_router.dart`
- `lib/screens/instructor/attendance/attendance_manager_screen.dart`
