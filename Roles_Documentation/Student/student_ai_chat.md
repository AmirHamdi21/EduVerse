# AI Chat — Student Feature Documentation

## 1. Feature Summary
The **AI Chat** capability belongs to the **Student** role and is grouped under **AI Learning**. This document captures implementation intent, navigation, architecture touchpoints, and operational expectations for maintainable evolution.

## 2. Access and Navigation
| Item | Details |
|---|---|
| Role Access | Student |
| Primary Route | `/ai-chat` |
| Primary Screen | `lib/screens/student/ai_chat/ai_chat_screen.dart` |
...
- `lib/config/app_router.dart`
- `lib/screens/student/ai_chat/ai_chat_screen.dart`
