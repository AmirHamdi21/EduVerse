# Do Not Disturb — Student Feature Documentation

## 1. Feature Summary
The **Do Not Disturb** capability belongs to the **Student** role and is grouped under **Profile & Settings**. This document captures implementation intent, navigation, architecture touchpoints, and operational expectations for maintainable evolution.

## 2. Access and Navigation
| Item | Details |
|---|---|
| Role Access | Student |
| Primary Route | `/settings/dnd` |
| Primary Screen | `lib/screens/student/settings/do_not_disturb_screen.dart` |
...
- `lib/config/app_router.dart`
- `lib/screens/student/settings/do_not_disturb_screen.dart`
