# Summarizer — Student Feature Documentation

## 1. Feature Summary
The **Summarizer** capability belongs to the **Student** role and is grouped under **AI Learning**. This document captures implementation intent, navigation, architecture touchpoints, and operational expectations for maintainable evolution.

## 2. Access and Navigation
| Item | Details |
|---|---|
| Role Access | Student |
| Primary Route | `/summarizer` |
| Primary Screen | `lib/screens/student/summarizer/summarizer_screen.dart` |
...
- `lib/config/app_router.dart`
- `lib/screens/student/summarizer/summarizer_screen.dart`
