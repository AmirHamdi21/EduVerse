# Discussions — Student Feature Documentation

## 1. Feature Summary
The **Discussions** capability belongs to the **Student** role and is grouped under **Communication**. This document captures implementation intent, navigation, architecture touchpoints, and operational expectations for maintainable evolution.

## 2. Access and Navigation
| Item | Details |
|---|---|
| Role Access | Student |
| Primary Route | `/discussions` |
| Primary Screen | `lib/screens/student/discussions/student_discussions_screen.dart` |
...
- `lib/config/app_router.dart`
- `lib/screens/student/discussions/student_discussions_screen.dart`
