# Edit Profile — Student Feature Documentation

## 1. Feature Summary
The **Edit Profile** capability belongs to the **Student** role and is grouped under **Profile & Settings**. This document captures implementation intent, navigation, architecture touchpoints, and operational expectations for maintainable evolution.

## 2. Access and Navigation
| Item | Details |
|---|---|
| Role Access | Student |
| Primary Route | `/edit-profile` |
| Primary Screen | `lib/screens/student/profile/edit_profile_screen.dart` |
