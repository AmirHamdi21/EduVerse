# Email Preferences — Student Feature Documentation

## 1. Feature Summary
The **Email Preferences** capability belongs to the **Student** role and is grouped under **Profile & Settings**. This document captures implementation intent, navigation, architecture touchpoints, and operational expectations for maintainable evolution.

## 2. Access and Navigation
| Item | Details |
|---|---|
| Role Access | Student |
| Primary Route | `/settings/email` |
| Primary Screen | `lib/screens/student/settings/email_preferences_screen.dart` |
...
- `lib/config/app_router.dart`
- `lib/screens/student/settings/email_preferences_screen.dart`
