# Calendar — Student Feature Documentation

## 1. Feature Summary
The **Calendar** capability belongs to the **Student** role and is grouped under **Dashboard & Productivity**. This document captures implementation intent, navigation, architecture touchpoints, and operational expectations for maintainable evolution.
...
| Primary Screen | `lib/screens/student/calendar/calendar_screen.dart` |
...
- `lib/config/app_router.dart`
- `lib/screens/student/calendar/calendar_screen.dart`
