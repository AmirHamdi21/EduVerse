# Storage Settings — Student Feature Documentation

## 1. Feature Summary
The **Storage Settings** capability belongs to the **Student** role and is grouped under **Profile & Settings**. This document captures implementation intent, navigation, architecture touchpoints, and operational expectations for maintainable evolution.

## 2. Access and Navigation
| Item | Details |
|---|---|
| Role Access | Student |
| Primary Route | `/settings/storage` |
| Primary Screen | `lib/screens/student/settings/storage_settings_screen.dart` |
...
- **Current Notes:** Settings UI exists; cloud-storage parity is partially documented/planned.
...
- `lib/config/app_router.dart`
- `lib/screens/student/settings/storage_settings_screen.dart`
