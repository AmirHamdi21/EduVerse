# Quiz List — Student Feature Documentation

## 1. Feature Summary
The **Quiz List** capability belongs to the **Student** role and is grouped under **Quizzes**. This document captures implementation intent, navigation, architecture touchpoints, and operational expectations for maintainable evolution.

## 2. Access and Navigation
| Item | Details |
|---|---|
| Role Access | Student |
| Primary Route | `/student/quizzes` |
| Primary Screen | `lib/screens/student/quizzes/student_quizzes_screen.dart` |
...
- `lib/config/app_router.dart`
- `lib/screens/student/quizzes/student_quizzes_screen.dart`
