# Profile — Student Feature Documentation

## 1. Feature Summary
The **Profile** capability belongs to the **Student** role and is grouped under **Profile & Settings**. This document captures implementation intent, navigation, architecture touchpoints, and operational expectations for maintainable evolution.
...
| Primary Screen | `lib/screens/student/profile/profile_screen.dart` |
