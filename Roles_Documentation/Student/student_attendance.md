# Attendance — Student Feature Documentation

## 1. Feature Summary
The **Attendance** capability belongs to the **Student** role and is grouped under **Grades & Attendance**. This document captures implementation intent, navigation, architecture touchpoints, and operational expectations for maintainable evolution.

## 2. Access and Navigation
| Item | Details |
|---|---|
| Role Access | Student |
| Primary Route | `/attendance` |
| Primary Screen | `lib/screens/student/attendance/attendance_screen.dart` |
...
- **Current Notes:** Attendance UI is complete; branch documentation indicates ongoing API parity improvements.
...
- `lib/config/app_router.dart`
- `lib/screens/student/attendance/attendance_screen.dart`
