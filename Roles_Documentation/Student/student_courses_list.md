# Courses List — Student Feature Documentation

## 1. Feature Summary
The **Courses List** capability belongs to the **Student** role and is grouped under **Courses & Enrollment**. This document captures implementation intent, navigation, architecture touchpoints, and operational expectations for maintainable evolution.

## 2. Access and Navigation
| Item | Details |
|---|---|
| Role Access | Student |
| Primary Route | `/courses` |
| Primary Screen | `lib/screens/student/courses_screen.dart` |
