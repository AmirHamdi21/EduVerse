# Share App QR — Student Feature Documentation

## 1. Feature Summary
The **Share App QR** capability belongs to the **Student** role and is grouped under **Profile & Settings**. This document captures implementation intent, navigation, architecture touchpoints, and operational expectations for maintainable evolution.

## 2. Access and Navigation
| Item | Details |
|---|---|
| Role Access | Student |
| Primary Route | `/settings/share-app/qr` |
| Primary Screen | `lib/screens/student/settings/share_app/qr_code_share_screen.dart` |
...
## 5. Primary User Flow
1. User opens `/settings/share-app/qr`.
...
- `lib/config/app_router.dart`
- `lib/screens/student/settings/share_app/qr_code_share_screen.dart`
