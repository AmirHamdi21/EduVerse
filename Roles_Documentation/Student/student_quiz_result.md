# Quiz Result — Student Feature Documentation

## 1. Feature Summary
The **Quiz Result** capability belongs to the **Student** role and is grouped under **Quizzes**. This document captures implementation intent, navigation, architecture touchpoints, and operational expectations for maintainable evolution.

## 2. Access and Navigation
| Item | Details |
|---|---|
| Role Access | Student |
| Primary Route | `/student/quiz-result` |
| Primary Screen | `lib/screens/student/quizzes/student_quiz_result_screen.dart` |
| Feature Category | Quizzes |
...
## 5. Primary User Flow
1. User opens `/student/quiz-result`.
...
|---|---|
| State Management | student_quiz_cubit, quiz_management_cubit |
| Service/API Layer | quiz_api_service.dart, quiz_ai_service.dart |
| Key Data Shapes | quiz metadata, attempts, questions, scoring payloads |
...
- Protect attempt timing and submission finalization rules.
- Prevent answer mutation after final submit.
- Release feedback according to configured policy.
...
- `lib/config/app_router.dart`
- `lib/screens/student/quizzes/student_quiz_result_screen.dart`
