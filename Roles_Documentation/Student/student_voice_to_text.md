# Voice to Text — Student Feature Documentation

## 1. Feature Summary
The **Voice to Text** capability belongs to the **Student** role and is grouped under **AI Learning**. This document captures implementation intent, navigation, architecture touchpoints, and operational expectations for maintainable evolution.

## 2. Access and Navigation
| Item | Details |
|---|---|
| Role Access | Student |
| Primary Route | `/voice-to-text` |
| Primary Screen | `lib/screens/student/voice_to_text/voice_to_text_screen.dart` |
...
- `lib/config/app_router.dart`
- `lib/screens/student/voice_to_text/voice_to_text_screen.dart`
