# Blocked Users — Student Feature Documentation

## 1. Feature Summary
The **Blocked Users** capability belongs to the **Student** role and is grouped under **Profile & Settings**. This document captures implementation intent, navigation, architecture touchpoints, and operational expectations for maintainable evolution.

## 2. Access and Navigation
| Item | Details |
|---|---|
| Role Access | Student |
| Primary Route | `/settings/blocked-users` |
| Primary Screen | `lib/screens/student/settings/blocked_users_screen.dart` |
...
## 5. Primary User Flow
1. User opens `/settings/blocked-users`.
...
- `lib/config/app_router.dart`
- `lib/screens/student/settings/blocked_users_screen.dart`
