# Assignments — Student Feature Documentation

## 1. Feature Summary
The **Assignments** capability belongs to the **Student** role and is grouped under **Assignments & Labs**. This document captures implementation intent, navigation, architecture touchpoints, and operational expectations for maintainable evolution.
...
| Primary Screen | `lib/screens/student/assignments_screen.dart` |
