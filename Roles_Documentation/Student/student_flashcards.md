# Flashcards — Student Feature Documentation

## 1. Feature Summary
The **Flashcards** capability belongs to the **Student** role and is grouped under **AI Learning**. This document captures implementation intent, navigation, architecture touchpoints, and operational expectations for maintainable evolution.
...
| Primary Screen | `lib/screens/student/flashcards_screen.dart` |
...
- `lib/config/app_router.dart`
- `lib/screens/student/flashcards_screen.dart`
