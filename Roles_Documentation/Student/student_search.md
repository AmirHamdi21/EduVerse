# Search — Student Feature Documentation

## 1. Feature Summary
The **Search** capability belongs to the **Student** role and is grouped under **Dashboard & Productivity**. This document captures implementation intent, navigation, architecture touchpoints, and operational expectations for maintainable evolution.
...
| Primary Screen | `lib/screens/student/search/overall_search_screen.dart` |
...
- `lib/config/app_router.dart`
- `lib/screens/student/search/overall_search_screen.dart`
