# Dashboard — Student Feature Documentation

## 1. Feature Summary
The **Dashboard** capability belongs to the **Student** role and is grouped under **Dashboard & Productivity**. This document captures implementation intent, navigation, architecture touchpoints, and operational expectations for maintainable evolution.
...
| Primary Screen | `lib/screens/student/student_dashboard_screen.dart` |
| Feature Category | Dashboard & Productivity |
...
|---|---|
| State Management | tasks_cubit, profile_cubit, courses_bloc, calendar_cubit |
| Service/API Layer | student_stats_service.dart, course_service.dart, schedule_service.dart |
| Key Data Shapes | task summary, student stats, course/event cards |
...
- Prioritize upcoming deadlines and overdue actions.
- Support quick refresh without forcing full-screen reset.
- Keep initial render responsive and role-focused.
...
- **Current Notes:** Main student landing experience; some widgets are still backed by lightweight placeholder data.
