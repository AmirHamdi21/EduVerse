# Share App APK — Student Feature Documentation

## 1. Feature Summary
The **Share App APK** capability belongs to the **Student** role and is grouped under **Profile & Settings**. This document captures implementation intent, navigation, architecture touchpoints, and operational expectations for maintainable evolution.

## 2. Access and Navigation
| Item | Details |
|---|---|
| Role Access | Student |
| Primary Route | `/settings/share-app/apk` |
| Primary Screen | `lib/screens/student/settings/share_app/apk_share_screen.dart` |
...
## 5. Primary User Flow
1. User opens `/settings/share-app/apk`.
...
- `lib/config/app_router.dart`
- `lib/screens/student/settings/share_app/apk_share_screen.dart`
