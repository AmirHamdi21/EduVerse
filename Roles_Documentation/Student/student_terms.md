# Terms — Student Feature Documentation

## 1. Feature Summary
The **Terms** capability belongs to the **Student** role and is grouped under **Profile & Settings**. This document captures implementation intent, navigation, architecture touchpoints, and operational expectations for maintainable evolution.
...
| Primary Screen | `lib/screens/student/settings/terms_of_service_screen.dart` |
...
- `lib/config/app_router.dart`
- `lib/screens/student/settings/terms_of_service_screen.dart`
